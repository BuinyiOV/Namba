...
export const dishes = {
	pl: {
		...
		appetizers: {
			...
			items: [
				{ rollNumber: "Przystawka 1", rollName: "Sałatka Goma Wakame", plateColor: "White", rollPrice: "18" },
				{ rollNumber: "Przystawka 2", rollName: "Chipsy krewetkowe (15 szt)", plateColor: "White", rollPrice: "18" },
				{ rollNumber: "Przystawka 3", rollName: "Onigiri (8 szt)", plateColor: "White", rollPrice: "18", description: "kuleczki ryżu obtoczone w sezamie (8szt)" },
				{ rollNumber: "Przystawka 4", rollName: "Edamaki (5 szt)", plateColor: "Grey", rollPrice: "20" },
				{ rollNumber: "Przystawka 5", rollName: "Gyoza z jabłkiem (6 szt)", plateColor: "Grey", rollPrice: "20" },
				{ rollNumber: "Przystawka 6", rollName: "Gyoza z kaczką (6 szt)", plateColor: "Brown", rollPrice: "25" },
				{ rollNumber: "Przystawka 7", rollName: "Gyoza z wieprzowiną na ostro (6 szt)", plateColor: "Brown", rollPrice: "25" },
				{ rollNumber: "Przystawka 8", rollName: "Warzywa w tempurze", plateColor: "Red", rollPrice: "30" },
				{ rollNumber: "Przystawka 9", rollName: "Sałatka Krabowa", plateColor: "Orange", rollPrice: "35" },
				{ rollNumber: "Przystawka 10", rollName: "Kalmary w tempurze (7 szt)", plateColor: "Yellow", rollPrice: "40" },
				{ rollNumber: "Przystawka 11", rollName: "Krewetka w tempurze (5 szt)", plateColor: "Green", rollPrice: "45" },
				{ rollNumber: "Przystawka 12", rollName: "Łosoś w tempurze (6 szt)", plateColor: "Green", rollPrice: "45" },
				{ rollNumber: "Przystawka 13", rollName: "Mix ryb w tempurze (6 szt)", plateColor: "Green", rollPrice: "45" },
				{ rollNumber: "Przystawka 14", rollName: "Tatar z łososia", plateColor: "Purple", rollPrice: "55" }
			]
		}
	},
	ua: {
		...
		appetizers: {
			...
			imageUrl: 'logo/Neon.svg',
			items: [
				{ rollNumber: "Закуска 1", rollName: "Салат Goma Wakame", plateColor: "White", rollPrice: "18" },
				{ rollNumber: "Закуска 2", rollName: "Чіпси з креветок (15 шт)", plateColor: "White", rollPrice: "18" },
				{ rollNumber: "Закуска 3", rollName: "Онiгірі (8 шт)", plateColor: "White", rollPrice: "18", description: "кульки рису обваляні в кунжуті (8шт)" },
				{ rollNumber: "Закуска 4", rollName: "Едамаки (5 szt)", plateColor: "Grey", rollPrice: "20" },
				{ rollNumber: "Закуска 5", rollName: "Гіоза з яблуком (6 szt)", plateColor: "Grey", rollPrice: "20" },
				{ rollNumber: "Закуска 6", rollName: "Гіоза з качкою (6 szt)", plateColor: "Brown", rollPrice: "25" },
				{ rollNumber: "Закуска 7", rollName: "Гіоза з гострою свининою (6 szt)", plateColor: "Brown", rollPrice: "25" },
				{ rollNumber: "Закуска 8", rollName: "Овочі в темпурі", plateColor: "Red", rollPrice: "30" },
				{ rollNumber: "Закуска 9", rollName: "Салат крабовий", plateColor: "Orange", rollPrice: "35" },
				{ rollNumber: "Закуска 10", rollName: "Кальмари в темпурі (7 шт)", plateColor: "Yellow", rollPrice: "40" },
				{ rollNumber: "Закуска 11", rollName: "Креветка в темпурі (5 шт)", plateColor: "Green", rollPrice: "45" },
				{ rollNumber: "Закуска 12", rollName: "Лосось в темпурі (6 шт)", plateColor: "Green", rollPrice: "45" },
				{ rollNumber: "Закуска 13", rollName: "Мікс риб в темпурі (6 шт)", plateColor: "Green", rollPrice: "45" },
				{ rollNumber: "Закуска 14", rollName: "Тартар з лосося", plateColor: "Purple", rollPrice: "55" }
			]
		},
	}
};
